...
```text
รับค่าจำนวนเต็มมา 2 จำนวน คือ จำนวนที่หมึกขยายต่อวิ และ จำตัวคน(s, n)
และวนลูปรับค่าจำนวนเต็มมา 2 จำนวน คือ ตำแหน่งแกน(x, y) เป็นจำนวนรอบ n
และคำนวณว่าเวลาที่หมึกจะขยายไปถึงบ้านของแต่ละหลังคือกี่วินาที
```
...
```text
1. รับค่าจำนวนเต็ม 2 จำนวน คือ จำนวนที่หมึกขยายต่อวิ และ จำตัวคน(s, n)
2. วนลูปรับค่าจำนวนเต็มมา 2 จำนวน คือ ตำแหน่งแกน(x, y) เป็นจำนวนรอบ n
3. ใช้สูตร 3.1416 * (x^2+y^2)/s คือ การหาขนาดพื้นที่ของวงกลม(หมึก)ที่ผ่านตำแหน่ง (x, y) และหารด้วย s คือความเร็วที่หมึกขยายใน 1 วิ
```
