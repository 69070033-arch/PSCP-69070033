...
```text
รับค่าจำนวนเต็ม a,b,goal 
a = อิฐก้อนเล็ก จะมีความยาว 1 นิ้ว
b = อิฐก้อนใหญ่ จะมีความยาว 5 นิ้ว
goal = เป้าหมายเป็นนิ้ว
ถ้า b เกินก็ให้ใช้เท่าที่ใช้ได้ แล้วนำ a มาใช้
...
หาค่า use_b คือค่าอิฐก้อนใหญ่ที่ต้องใช้โดยนำ goal มาหารไม่เศษและเทียบกันกับ b ว่าอันไหนน้อยกว่าเขียนได้เป็น
use_b = min(goal//5, b)
หาค่า use_a คือค่าอิฐก้อนเล็กที่ต้องใช้โดยนำ goal มาลบกับ use_b ที่คูณ 5 แล้วจะเขียนได้เป็น
use_a = goal - (use_b * 5)
แล้วนำมาเทียบว่า อิฐก้อนเล็ก และ อิฐก้อนใหญ่ ที่ต้องใช้มีมากว่าอิฐที่มีอยู่มั้ย use_a > a or use_b > b
ถ้าจริงให้พิม -1
ถ้าไม่ให้พิม use_a ค่าอิฐก้อนเล็กที่ต้องใช้
```
...
```text
เพราะอิฐมีพอดีควรแสดงค่าอิฐเล็กที่ต้องใช้
```
...
```text
เพราะอิฐมีเกินควรแสดงค่าอิฐเล็กที่ต้องใช้
```
