...
```text
รับจำนวนเต็ม n และนับถอยหลังไปจนถึง 0 
แสดงค่าตัวเลขที่หารด้วย 10 ลงตัว
```
...
```text
รับค่า n
ใน for loop นับถอยหลังและเช็คว่าจำนวน i ด้วย 10 ลงตัวไหม
ถ้าใช่แสดงค่าตัว i
```
...
```text
เพราะไม่ได้เริ่มจากตัวเลขที่หาร 10 ลงตัว
```
