...
```text
โจทย์ให้เขียนโปรแกรมรับข้อความหรือสตริงทั้งหมด 5 บรรทัด จากนั้นนำข้อความทั้งหมดมาพิมพ์ล้อมรอบด้วยกรอบเครื่องหมายดอกจัน * โดยความกว้างของกรอบจะถูกกำหนดตามความยาวของสตริงที่ยาวที่สุด

- Input: รับข้อความ 5 บรรทัด
- Output: พิมพ์กรอบสี่เหลี่ยมด้วยเครื่องหมาย * ที่มีความกว้างพอดีกับข้อความที่ยาวที่สุด และแสดงข้อความแต่ละบรรทัดไว้ข้าง
```
...
```text
ตอนแรกคิดว่าจะเก็บสตริงทั้ง 5 บรรทัดลงในลิสต์ จากนั้นใช้ฟังก์ชัน len() ร่วมกับ max(key=len) เพื่อหาความยาวของสตริงที่ยาวที่สุด แล้วคำนวณจำนวนช่องว่างที่ต้องเติมต่อท้ายแต่ละข้อความเพื่อให้กรอบฝั่งขวาตรงกัน จากนั้นจึงสั่งพิมพ์กรอบด้านบน ข้อความแต่ละบรรทัด และกรอบด้านล่างตามลำดับ
```
...
```text
ทดสอบข้อความที่มีความยาวแตกต่างกัน
```
...
```text
ทดสอบกรณีที่ข้อความมีความยาวเท่ากันทุกบรรทัด
```
...
```text
ทดสอบกรณีที่มีสตริงยาวเพียวตัวเดียว
```
