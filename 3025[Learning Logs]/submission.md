...
```text
Input:
รับจำนวนเต็มค่า month และ days

Output:
โปรแกรมควรพิมฤดู "winter", "spring", "summer", "fall"

Constraints:
ฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว
Input: 1, 2, 3 เป็น ฤดูหนาว (winter)
Input: 4, 5, 6 เป็น ฤดูใบไม้ผลิ (spring)
Input: 7, 8, 9 เป็น ฤดูร้อน (summer)
Input: 10, 11, 12 เป็น ฤดูใบไม้ร่วง (fall)
```
...
```text
Step 1: อ่านค่าจำนวนเต็ม n
Step 2: ตรวจค่าว่า month เกิน 12 หรือไม่
Step 3: ถ้าจริงให้ month -= 12
Step 4: ตรวจค่าว่า month หาร 3 ลงตัวหรือไม่และ days ว่ามากกว่า >= 21 หรือไม่ 
Step 5: ถ้าจริงให้ month += 1
Step 6: ให้อ่านค่า month ว่าอยู่ในระยะเท่าไหร่
1, 2, 3 เป็น ฤดูหนาว (winter)
4, 5, 6 เป็น ฤดูใบไม้ผลิ (spring)
7, 8, 9 เป็น ฤดูร้อน (summer)
10, 11, 12 เป็น ฤดูใบไม้ร่วง (fall)
```
...
```text
เพราะ days >= 21 แต่ month หาร 3 ไม่ลงตัว
```
...
```text
เพราะ month หาร 3 ลงตัวและ days >= 21
```
