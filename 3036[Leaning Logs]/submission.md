...
```text
รับค่าจำนวน n 
ต้องไต่ขึ้นปราสาทสามเหลี่ยมไปถึงชั้นบนสุดคือ 1 โดยใช้ตาเดินได้น้อยที่สุดเริ่มจาก n 
...
```text
รับค่าจำนวนเต็ม n
กำหนดให้ r คือ รูท n และปัดเศษ r ขึ้น, r คือการหาชั้นของเลข n
กำหนดให้ k คือ n - (r - 1)^2, k คือการหาตำแหน่งของ n บนชั้น r,
เช็คว่า k เป็นสามเหลี่ยมหัวทิ่มหรือไม่ k หาร 2 ลงตัวไหม
ถ้าจริง wall จะเท่ากับ (2 * r) - 3
ถ้าเท็จ wall จะเท่ากับ (2 * r) - 2 
```
...
```text
อยู่ชั้น 2 และเป็นสามเหลี่ยมหัวขึ้น
```
...
```text
อยู่ชั้น 2 และเป็นสามเหลี่ยมหัวทิ่ม
```
