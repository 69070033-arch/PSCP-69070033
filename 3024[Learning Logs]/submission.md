...
```text
รับค่าคะแนนทั้งหมดและคะแนนที่สูงที่สุดมา

แล้วเช็คว่ามีความเป็นไปได้มั้ยที่จะมีหน้าม้ามาโหวตโดยถ้าคะแนนสูงที่สุดและต่ำที่สุดห่างกันเกิน 2
```
...
```text
หาค่าของ 2 คนที่เหลือโดยเอา คะแนนสูงสุด - คะแนนทั้งหมด และหาคะแนนต่ำที่สุดโดยเอา คะแนนสูงสุด - คะแนนของ 2 คนที่เหลือ จะได้ผลรับที่ออกมาเป็นคะแนนต่ำสุด คะแนนสูงสุด - คะแนนต่ำสุด ถ้ามากว่า 2 ถือว่า Surprising
```
