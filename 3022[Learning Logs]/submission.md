...
```text
แปลงค่าอุณหภูมิจากค่าจำนวณเต็ม

Input: รับค่าจำนวณเต็ม และ ตัวอักษร 2 ตัว

Output: ค่าที่แปลงออกมา

Constraints: ตรวจตัวอักษรว่า ตัวแรกเป็น C,F,K,R และ ตัวที่สองเป็น C,F,K,R ทำการแปลงค่าอุณหภูมิ จาก ตัวแรกเป็นตัวที่สอง
```
...
```text
Step 1: อ่านจำนวนเต็ม, char ตัวที่ 1, char ตัวที่ 2
Step 2: ตรวจค่า char1 และ char2
Step 3: แปลงค่าจำนวณเต็มที่รับมาและแปลงจากสูตร char1 ไปเป็น char2 
```
...
```text
ตั้งให้คำนวณ องศาเซลเซียส เป็นหลักและคำควณจากสูตรเพื่อลดการใช้ if else ที่ไม่จำเป็น
```
...
```text
เพราะแปลงจาก C ไปเป็น C ควรตอบเท่าเดิม
```
...
```text
เริ่มจากที่ไม่ใช่ C ไปเป็นอะไรก็ได้
```
